[![pages-build-deployment](https://github.com/Ahmed-Bayoumy/OMADS/actions/workflows/pages/pages-build-deployment/badge.svg?branch=DEV?branch=DEV)](https://github.com/Ahmed-Bayoumy/OMADS/actions/workflows/pages/pages-build-deployment)
...
# OMADS
OMADS: A Python implementation for the optimization using the mesh adaptive direct search (MADS) method; Optimization using MADS (OMADS). OMADS can solve both single- and multi-objective optimization problems.
