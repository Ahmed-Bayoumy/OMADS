...
from .exploration import VNS
from ._globals import SEARCH_TYPE, SAMPLER_TYPE
from ._globals import SUCCESS_TYPES, VAR_TYPE, STOP_TYPE
from .context_manager import WarningSuppressor
from .point import Point
from .candidate_point import CandidatePoint
from ._common import logger, MSG_TYPE, validator
from .parameters import Parameters
from .options import Options
from .postprocess import Output, PostMADS
from .metrics import Metrics
from .metadata import MadsState, MadsStatistics
from .poll_step import poll_cycle
from .search_step import search_cycle
from .updates import set_frame_centers_and_hvalues, update
...
def main(*args) -> Dict[str, Any]:
  ...
  if log is not None:
    ...
    log.log_msg(
        ...
        msg_type=MSG_TYPE.INFO)
    log.log_msg(
        msg=f" # Duplicate (cache) hits =  {stats.ncache_hits} ", msg_type=MSG_TYPE.INFO)
    log.log_msg(
