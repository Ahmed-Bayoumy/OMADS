...
from .._include import VAR_TYPE, DType, BARRIER_TYPES, MPP, DESIGN_STATUS, COMPARE_TYPE
...
class CandidatePoint:
  ...
  def __compare__(self, other):  # noqa: C901
    ...
    if (self.status == DESIGN_STATUS.INFEASIBLE and other.status == DESIGN_STATUS.INFEASIBLE) or \
            DESIGN_STATUS.INFEASIBLE in [self.status, other.status]:
